    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('attendances.mark') }}">
            ...
            <div class="mb-3" style = "max-width: 300px;">
                ...
                <input type="text" class="form-control" id="student_id" name="student_id" required pattern="[A-Za-z0-9_]+" title="Student Id should only contain letters, numbers, and underscores.">
            </div>
